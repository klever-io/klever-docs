export const metadata = {
  ...
  description:
    'Instructions for integrating exchanges with Klever Blockchain, including node deployment, API usage, custom integrations, and testing on testnet and mainnet.',
}
