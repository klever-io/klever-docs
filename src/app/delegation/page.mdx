export const metadata = {
  title: 'Delegation',
  description: 'Learn how to perform delegation operations on Klever Blockchain. Complete guide to delegating your KLV tokens to validators and earning rewards.',
}
