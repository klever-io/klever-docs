...
- **Local Mode**: 12 tools (all read-only + project tools + SDK management + context writing)
...
- `runtime_behavior`: VM runtime behavior explanations
...
**Parameters**:
- `type` (required): Context type (code_example, best_practice, security_tip, optimization, documentation, error_pattern, deployment_tool, runtime_behavior)
