...
- **Try MCP Prompts**: [Use guided workflows for common tasks](/using-ai-on-kvm/mcp-reference/mcp-prompts)
- **Explore Knowledge Base**: [Browse curated Klever development entries](/using-ai-on-kvm/mcp-reference/knowledge-base)
...
**Try it online**: Start developing with AI assistance at [ai.klever.org](https://ai.klever.org).
