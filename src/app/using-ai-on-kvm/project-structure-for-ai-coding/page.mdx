export const metadata = {
  title: 'Project Structure for AI-Assisted Development',
  description:
    'Guide to using the Klever MCP Project Specification Template for structured smart contract development. Explains benefits, prompt structure, example usage, template components, and when to apply it for effective AI-assisted development.',
}
