export const metadata = {
  ...
  description:
    'Learn how to become a Klever Validator Node: staking requirements, CLI commands for registration, freezing and delegating KLV, and configuring validator settings.',
}
