export const metadata = {
  title: 'API and SDK',
  description: 'Explore Klever Blockchain APIs and SDKs for seamless integration. Access comprehensive documentation for REST APIs, GraphQL endpoints, and development tools.',
}
