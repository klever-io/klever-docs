export const metadata = {
  title: 'Royalties',
  description:
    'Overview of how royalties work in Klever Blockchain: types, configuration, automation with Asset Trigger contracts, and fee distribution for tokens and NFTs.',
}
