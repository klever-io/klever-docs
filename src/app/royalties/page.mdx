export const metadata = {'title': 'Royalties', 'description': 'Content for royalties'}
...
1. Transfer fixed: Charges a fixed amount of KLV every time someone transfers an NFT from one account to another. This applies only to NFTs.
