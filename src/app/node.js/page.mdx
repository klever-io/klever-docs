export const metadata = {
  title: 'Node.js SDK',
  description:
    'Guides and reference for using the Klever Node.js SDK: quick start, changing networks, offline transactions, account methods, utilities, and automation scripts.',
}
