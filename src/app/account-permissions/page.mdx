export const metadata = {
  ...
  description:
    'Learn how to configure account permissions, thresholds, operations, and PermID in Klever Blockchain, including multi-signature and UpdateAccountPermission transactions.',
}
