...
### [Functions](/ai-for-kvm/mcp-reference/functions)
...
[View complete functions reference →](/ai-for-kvm/mcp-reference/functions)

### [MCP Prompts](/ai-for-kvm/mcp-reference/mcp-prompts)
...
[Learn about MCP prompts →](/ai-for-kvm/mcp-reference/mcp-prompts)

### [Knowledge Base](/ai-for-kvm/mcp-reference/knowledge-base)
...
[Explore knowledge base →](/ai-for-kvm/mcp-reference/knowledge-base)

## Resources

- **Installation**: [AI Environment Setup](/ai-for-kvm/ai-environment-setup)
- **Functions**: [Complete Functions Reference](/ai-for-kvm/mcp-reference/functions)
- **Prompts**: [MCP Prompts Guide](/ai-for-kvm/mcp-reference/mcp-prompts)
- **Knowledge**: [Knowledge Base Overview](/ai-for-kvm/mcp-reference/knowledge-base)
