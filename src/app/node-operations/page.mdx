export const metadata = {
  ...
  description:
    'Comprehensive guide to running Klever Blockchain nodes: setup, system requirements, wallet creation, validator configuration, fallback nodes, CLI operations, and maintenance tasks.',
}
