...
- [operator account create](undefined) - create a new wallet PEM file
- [operator account CSV](undefined) - send transactions based on a CSV file
- [operator account delegate](undefined) - delegate a bucket to a validator
- [operator account export-sk](undefined) - export-sk: print hex-encoded private key from a PEM file
- [operator account freeze](undefined) - freeze an asset
- [operator account import-sk](undefined) - import-sk: creates a PEM file from a hex-encoded secret key
