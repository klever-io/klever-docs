export const metadata = {
  ...
  description: 'Complete guide to Klever Blockchain node operations. Learn how to set up, configure, and maintain observer nodes and validators on the Klever network.',
}
