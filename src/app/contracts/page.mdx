export const metadata = {
  title: 'Contracts',
  description:
    'Overview of Klever Blockchain contracts and their functionalities, including transfers, staking, validators, marketplace, ITO, asset triggers, and common contract flows.',
}
