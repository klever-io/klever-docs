...
| Create Asset              | Creates a new fungible token or a NFT/[SFT](/semi-fungible-tokens) collection.                                                                          |
...
| Asset Trigger             | Updates the properties or trigger functionalities of a fungible token, NFT/[SFT](/semi-fungible-tokens) collection, or a single NFT/SFT. See # Asset Triggers. |
