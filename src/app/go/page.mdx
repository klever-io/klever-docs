export const metadata = {
  title: 'Go',
  description:
    'Guide to using the Go SDK with Klever Blockchain, including quick start, wallet handling, creating and signing transactions, deploying and invoking smart contracts, and encoding types.',
}
