export const metadata = {
  title: 'Builtin Contracts in Klever',
  description:
    'Reference for the Klever Blockchain Builtin Contracts and their methods. Covers asset management (transfer, create, freeze/unfreeze, delegate, withdraw, claim), marketplace operations, staking, royalties, metadata updates, account naming, governance voting, ITO setup, and NFT/asset triggers with examples.',
}
