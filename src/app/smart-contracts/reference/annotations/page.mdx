...
For beginners, the [Crowdfunding tutorial](/smart-contracts/how-to/crowdfunding) is a great resource. This document aims to be a comprehensive guide to all the annotations you'll encounter in smart contract development.
