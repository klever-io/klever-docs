...
For more examples and modules, visit: [Klever VM SDK RS Modules](https://github.com/klever-io/klever-vm-sdk-rs/tree/master/contracts/modules)(will be available on the TestNet phase 02).
