export const metadata = {
  ...
  description:
    'Explains how randomness works in Klever smart contracts using Golang’s seeded RNG with block seeds and tx hash. Covers generating random numbers and bytes with ManagedBuffer and RandomnessSource, shuffling with Fisher-Yates, assigning random hashes to NFTs, and best practices to avoid exploitable logic.',
}
