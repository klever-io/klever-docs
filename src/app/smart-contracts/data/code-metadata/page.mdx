export const metadata = {
  title: 'Code Metadata',
  description:
    'Explanation of code metadata flags in Klever smart contracts: upgradeable, readable, payable, and payable by smart contracts. Includes usage with koperator, bit-flag layout, and deployment examples.',
}
