export const metadata = {
  ...
  description:
    'Guide to encoding composite values in Klever smart contracts: lists, arrays, tuples, and options. Includes Rust type mappings, top-level vs nested encoding, and practical examples.',
}
