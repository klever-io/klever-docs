export const metadata = {
  title: 'Simple Values',
  description:
    'Covers the fundamental types in Klever smart contracts: fixed-width numbers, big numbers, booleans, byte slices, strings, addresses, and token identifiers. Explains top-level vs nested encoding with detailed examples.',
}
