export const metadata = {
  title: 'How to Set a Contract Name',
  description:
    'Step-by-step guide to adding an endpoint for setting a smart contract name in Klever Blockchain, invoking it via KleverScan, and verifying it on Klever Explorer.',
}
