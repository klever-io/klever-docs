export const metadata = {
  title: 'How to Call Smart Contracts from the Frontend',
  description:
    'Step-by-step guide to interact with Klever smart contracts from your frontend app, including setup, reading data, writing transactions, handling parameters, and complete examples with the Klever SDK.',
}
