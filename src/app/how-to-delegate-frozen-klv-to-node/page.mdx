export const metadata = {'title': 'how-to-delegate-frozen-klv-to-node', 'description': 'Content for how-to-delegate-frozen-klv-to-node'}

# how-to-delegate-frozen-klv-to-node

Content for how-to-delegate-frozen-klv-to-node
...
> gitbook-to-md
> node built/gitbook-to-md.js /home/lucas/Documents/gitbook-md/gitbook-to-md/data/Klever Finance/become-a-validator/how-to-freeze-klv-for-staking.json
