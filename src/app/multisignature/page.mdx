export const metadata = {
  ...
  description: 'Discover multisignature functionality on Klever Blockchain. Learn how to create and manage multi-signature wallets for enhanced security and collaborative asset management.',
}
