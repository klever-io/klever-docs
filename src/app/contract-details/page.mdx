...
|  Required  |      Parameter      |       Type       |               Description                |
|:----------:|---------------------|------------------|------------------------------------------|
|   ✅  |     triggerType     |      number      | Sets the trigger type (check [list below](undefined)) |
|   ✅  |      assetId        |      string      | Target Asset                             |
|   <input type="checkbox"  disabled/>  |      receiver       |      string      | Target address for transaction           |
|   <input type="checkbox"  disabled/>  |       amount        |      number      | Amount (with [precision](undefined))                  |
...
|   <input type="checkbox"  disabled/>  |        role      |         [Role](undefined) object array          | Role for Add/Remove Role types    |
|   <input type="checkbox"  disabled/>  |       staking         |        [Staking](undefined) object   | Used for updating staking params                           |
|   <input type="checkbox"  disabled/>  |       royalties       |     [Royalties](undefined) object    | Used for updating royalties params            |
|   <input type="checkbox"  disabled/>  |       kdaPool         |      [KDAPool](undefined) object     | Used for updating kdaPool params                           |


### RoyaltiesInfo structure
|  Required  |       Parameter       |           Type           |               Description                |
|:----------:|-----------------------|-------------------------|------------------------------------------|
|   ✅  |       address         |         string          | Royalty receiver address                |
|   <input type="checkbox"  disabled/>  | transferPercentage    | [RoyaltyInfo](undefined) object array | Transfer fee for fungible tokens ([precision](undefined) 2) |
|   <input type="checkbox"  disabled/>  |    transferFixed     |         number          | Transfer fee for non-fungible tokens    |
|   <input type="checkbox"  disabled/>  | marketPercentage      |         number          | Market percentage fee details for non-fungible tokens ([precision](undefined) 2) |
|   <input type="checkbox"  disabled/>  |    marketFixed       |         number          | Market fixed fee for non-fungible tokens |
|   <input type="checkbox"  disabled/>  |    itoPercentage     |         number          | ITO percentage fee (precision 2)        |
|   <input type="checkbox"  disabled/>  |       itoFixed       |         number          | ITO fixed fee (in the currency asset precision) |
|   <input type="checkbox"  disabled/>  |  splitRoyalties      | `{[address:string]: RoyaltySplitInfo}` | Defines the percentage of the fees when multiple addresses receive royalties |
...
|:----------:|-----------------------|-------------------------|------------------------------------------|
|   <input type="checkbox"  disabled/>  |       amount          |         number          | Max amount for that percentage           |
|   <input type="checkbox"  disabled/>  |    percentage         |         number          | Fee % ([precision](undefined) 2)                     |
...
|  Required  |      Parameter      |   Type   |               Description                |
|:----------:|---------------------|----------|------------------------------------------|
|   ✅  |     depositType     |  number  | 0: FPR Deposit, 1: KDA Pool, For more info, check #[Deposit Type](undefined) |
|   ✅  |         kda         |  string  | Target Asset                            |
