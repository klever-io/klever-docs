...
| <input type="checkbox"  disabled/>       | price        | number | Price for instant sell (with [precision](undefined))      |
| <input type="checkbox"  disabled/>       | reservePrice | number | Minimum auction price (with [precision](undefined))       |
...
| <input type="checkbox"  disabled/>      |commission    | number | Change commission ([precision](undefined) 2)    |
