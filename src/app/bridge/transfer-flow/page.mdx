...
> For detailed information about the user interaction [User Interaction documentation](./user-interaction).
> For more details on bridge architecture, contracts, and token types, visit the [Klever Bridge main documentation](./bridge).