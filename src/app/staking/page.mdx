export const metadata = {
  title: 'Staking',
  description: 'Complete guide to staking on Klever Blockchain. Learn how to stake KLV tokens, participate in network validation, and earn rewards through the staking mechanism.',
}
